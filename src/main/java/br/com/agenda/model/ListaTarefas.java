...
public class ListaTarefas {
	...
	public ListaTarefas(Long id, String descricao, Date dataCadastro, int status_tarefa, Date dataExecucao,
	...
	public String toString() {
		return "ListaTarefas [id=" + id + ", descricao=" + descricao + ", dataCadastro=" + dataCadastro
				+ ", status_tarefa=" + status_tarefa + ", dataExecucao=" + dataExecucao + ", dataConclusao="
